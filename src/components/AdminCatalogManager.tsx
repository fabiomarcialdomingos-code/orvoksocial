...
async function read<T>(url: string): Promise<T> {
  ...
  if (!response.ok) {
    ...
    throw new Error(payload?.error?.message ?? "Não foi possível carregar os pré-cadastros.");
  }
